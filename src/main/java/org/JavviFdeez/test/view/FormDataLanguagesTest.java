...
import org.JavviFdeez.controller.view.FormDataCoursesController;
import org.JavviFdeez.controller.view.FormDataLanguagesController;

import java.io.IOException;

public class FormDataLanguagesTest extends Application {
    public void start(Stage primaryStage) throws IOException {
        try {
            ...
            FormDataLanguagesController controller = loader.getController();
