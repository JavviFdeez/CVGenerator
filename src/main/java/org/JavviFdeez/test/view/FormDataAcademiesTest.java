...
import org.JavviFdeez.controller.view.FormDataContactController;

import java.io.IOException;

public class FormDataAcademiesTest extends Application {
    public void start(Stage primaryStage) throws IOException {
        try {
            ...
            FormDataAcademiesController controller = loader.getController();
