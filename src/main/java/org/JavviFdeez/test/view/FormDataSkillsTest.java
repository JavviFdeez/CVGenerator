...
import org.JavviFdeez.controller.view.FormDataSkillsController;

import java.io.IOException;

public class FormDataSkillsTest extends Application {
    public void start(Stage primaryStage) throws IOException {
        try {
            ...
            FormDataSkillsController controller = loader.getController();
